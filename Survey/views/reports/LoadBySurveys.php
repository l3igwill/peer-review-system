<div id="main" style="height: 100%">
    ...
    <h2>Reviews done by <?php foreach($students as $student){if($student['student_id']==$_POST['reviewee']){echo $student['student_name'];}}?></h2>
    ...
    <?php foreach($_POST['selected_surveys'] as $survey) {
        ...
        foreach($students as $student){
            if($student['student_id']==$currentSurvey['student_reviewed']){
                echo "<br><h4>Review of ".$student['student_name']." - Time: ".number_format(((float)$currentSurvey['survey_time'])/60,2)." Minutes</h4>";
            }
        }
